<template>
    <nav class="sidebar" v-if="App.ready">
        ...
        <div class="menu-buttons">
            ...
            <button class="menu-button" @click="openTests()">
...
<script setup>
    ...
    const openTests = async () => {
        await Network.send({ command: 'showPopup', params: { url: 'internals/assets/tests.html', width: 700, height: 500, params: {}, parentWindowId: App.windowId } });
    };
